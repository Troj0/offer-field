...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return CommentField; });
...
var CommentField = /*#__PURE__*/function (_Component) {
  Object(_babel_runtime_helpers_esm_inheritsLoose__WEBPACK_IMPORTED_MODULE_0__["default"])(CommentField, _Component);

  function CommentField() {
    return _Component.apply(this, arguments) || this;
  }

  var _proto = CommentField.prototype;
...
flarum_app__WEBPACK_IMPORTED_MODULE_0___default.a.initializers.add('alterbyte/offer-field', function () {
  ...
  Object(flarum_extend__WEBPACK_IMPORTED_MODULE_1__["extend"])(flarum_components_CommentPost__WEBPACK_IMPORTED_MODULE_4___default.a.prototype, 'headerItems', function (items) {
    ...
    var bidding = this.props.post.attribute('alterbyteBidding');

    if (flarum_app__WEBPACK_IMPORTED_MODULE_0___default.a.forum.attribute('alterbyteBiddingCanSubmit') && thisPost.number() != 1 && bidding !== null) {
      var _bidding = this.props.post.attribute('alterbyteBidding') + " ر.س";

      if (_bidding !== null || _bidding !== '' || _bidding !== 0) {
