...
flarum_app__WEBPACK_IMPORTED_MODULE_0___default.a.initializers.add('alterbyte/offer-field', function () {
  Object(flarum_extend__WEBPACK_IMPORTED_MODULE_1__["extend"])(flarum_components_PermissionGrid__WEBPACK_IMPORTED_MODULE_2___default.a.prototype, 'viewItems', function (items) {
    items.add('alterbyte-bidding', {
      ...
      label: flarum_app__WEBPACK_IMPORTED_MODULE_0___default.a.translator.trans('alterbyte-bidding.admin.permission.view'),
  ...
  Object(flarum_extend__WEBPACK_IMPORTED_MODULE_1__["extend"])(flarum_components_PermissionGrid__WEBPACK_IMPORTED_MODULE_2___default.a.prototype, 'replyItems', function (items) {
    items.add('alterbyte-bidding', {
      icon: 'fas fa-star-half-alt',
      label: flarum_app__WEBPACK_IMPORTED_MODULE_0___default.a.translator.trans('alterbyte-bidding.admin.permission.submit'),
  ...
  Object(flarum_extend__WEBPACK_IMPORTED_MODULE_1__["extend"])(flarum_components_PermissionGrid__WEBPACK_IMPORTED_MODULE_2___default.a.prototype, 'moderateItems', function (items) {
    items.add('alterbyte-bidding', {
      icon: 'fas fa-star-half-alt',
      label: flarum_app__WEBPACK_IMPORTED_MODULE_0___default.a.translator.trans('alterbyte-bidding.admin.permission.moderate'),
